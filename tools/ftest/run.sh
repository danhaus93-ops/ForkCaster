...
cd "$(dirname "$0")"
tot=0; bad=0
for t in grocery-test.js struct-test.js engines-test.js chain-test.js delivery-test.js train-test.js bodyscan-test.js photos-test.js foodsearch-test.js render-smoke.js; do
  echo "── $t"
