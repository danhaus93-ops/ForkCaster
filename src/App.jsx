...
const iconMed = (c) => (<svg width="22" height="22" viewBox="0 0 24 24" fill="none"><rect x="3" y="9" width="18" height="6" rx="3" transform="rotate(-45 12 12)" stroke={c} strokeWidth="2" /><path d="M9 9l6 6" stroke={c} strokeWidth="2" /></svg>);
